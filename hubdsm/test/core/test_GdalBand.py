...
class TestGdalBand(TestCase):
    ...
    def test_metadata(self):
        gdalBand = GdalBand.open(MEM_DRIVER.createFromArray(array=np.array([[[1]]])), number=1)
    ...
    def test_categories(self):
        gdalBand = GdalBand.open(MEM_DRIVER.createFromArray(array=np.array([[[1]]], dtype=np.uint8)), number=1)
