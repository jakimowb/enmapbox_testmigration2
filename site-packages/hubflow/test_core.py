...
#                              falseRanges=[(-9999, 0)], falseValues=[-9999]))
    ...
    def test_VectorRegression(self):
        print(VectorRegression(filename=r'C:\Users\janzandr\Desktop\test.shp', regressionAttribute='tmp2'))
...
class TestEnviSpectralLibrary(TestCase):
    ...
    def test_debug(self):
        ...
        rfc = Classifier(sklEstimator=RandomForestClassifier())
        rfc.fit(sample=sample)
        rfc.pickle(filename=join(outdir, 'rfc.pkl'))

        import matplotlib.pyplot as plt
        rfc = Classifier.unpickle(filename=r'C:/Users/janzandr/AppData/Local/Temp/processing_6d748f465b424190ac10605c8e595707/8df6b629faaf477ba1c7e878ee775e1a/outClassifier.pkl')
        plt.plot(rfc.sklEstimator().feature_importances_)
        plt.show()
        a=1
