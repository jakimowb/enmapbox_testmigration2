...
class RasterBandSubsetting(EnMAPAlgorithm):
    ...
    def defineCharacteristics(self):
        self.addParameterRaster()
        self.addParameterStringList(description='Band subset', help='List of bands to subset. E.g. 1, 2, -1 will select the first, the second and the last band.')
...
class RegressionSampleFromArtmo(EnMAPAlgorithm):
    def group(self): return self.GROUP_AUXILLIARY
