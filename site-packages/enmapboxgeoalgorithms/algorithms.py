...
class CreateTestClassification(EnMAPAlgorithm):
    ...
    def processAlgorithm_(self):
        ...
        result = enmapboxtestdata.createClassification(filename=self.getParameterOutputClassification(),
...
class CreateTestFraction(EnMAPAlgorithm):
    ...
    def processAlgorithm_(self):
        import enmapboxtestdata
        result = enmapboxtestdata.createFraction(filename=self.getParameterOutputFraction(),
                                                 gridOrResolution=Raster(enmapboxtestdata.enmap).grid())
...
# test workshop algo
#try:
#    from enmapboxworkshop2019 import RegressionBasedUnmixing
#    ALGORITHMS.append(RegressionBasedUnmixing())
#except: pass
