...
@typechecked
class SpatialMorphologicalWhiteTophatAlgorithm(ApplyBandFunctionAlgorithmBase):
    ...
    def shortDescription(self) -> str:
        ...
        return f'Spatial morphological top-hat filter. See {link} for general information.'
