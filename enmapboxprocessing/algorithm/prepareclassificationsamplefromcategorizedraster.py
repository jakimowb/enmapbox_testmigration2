...
class PrepareClassificationSampleFromCategorizedRaster(EnMAPProcessingAlgorithm):
    ...
    P_FEATURE_LIST, _FEATURE_LIST = 'featureList', 'Selected bands/features'
    ...
    def helpParameters(self) -> List[Tuple[str, str]]:
        return [
            (self._CATEGORIZED_RASTER,
             f'Categorized samples. {self.helpParameterMapClassification()} '
            ...
            (self._CATEGORY_BAND, 'Raster band used for sampling class values. '
                                  'If not selected, the band defined by the categorized renderer is used. '
