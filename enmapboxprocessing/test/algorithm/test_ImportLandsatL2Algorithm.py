...
class TestImportLandsatL2Algorithm(TestCase):
    ...
    def test_L8_C1(self):
        ...
        parameters = {
            ...
            alg.P_OUTPUT_RASTER: 'c:/vsimem/landsat8L2C1.vrt'
        }
    ...
    def test_L8_C2(self):
        ...
        parameters = {
            ...
            alg.P_OUTPUT_RASTER: 'c:/vsimem/landsat8L2C2.vrt'
        }
        result = self.runalg(alg, parameters)
        array = RasterReader(result[alg.P_OUTPUT_RASTER]).array(bandList=[1])
    ...
    def test_L7_C1(self):
        ...
        parameters = {
            ...
            alg.P_OUTPUT_RASTER: 'c:/vsimem/landsat7L2C1.vrt'
        }
        result = self.runalg(alg, parameters)
        array = RasterReader(result[alg.P_OUTPUT_RASTER]).array(bandList=[1])
    ...
    def test_L7_C2(self):
        ...
        parameters = {
            ...
            alg.P_OUTPUT_RASTER: 'c:/vsimem/landsat7L2C2.vrt'
        }
        result = self.runalg(alg, parameters)
        array = RasterReader(result[alg.P_OUTPUT_RASTER]).array(bandList=[1])
    ...
    def test_L5_C1(self):
        ...
        parameters = {
            ...
            alg.P_OUTPUT_RASTER: 'c:/vsimem/landsat5L2C1.vrt'
        }
        result = self.runalg(alg, parameters)
        array = RasterReader(result[alg.P_OUTPUT_RASTER]).array(bandList=[1])
    ...
    def test_L5_C2(self):
        ...
        parameters = {
            ...
            alg.P_OUTPUT_RASTER: 'c:/vsimem/landsat5L2C2.vrt'
        }
        result = self.runalg(alg, parameters)
        array = RasterReader(result[alg.P_OUTPUT_RASTER]).array(bandList=[1])
