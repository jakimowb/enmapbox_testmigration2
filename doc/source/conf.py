...
MOCK_MODULES = ['qgis','qgis.core','qgis.gui','gdal','sklearn','numpy', 'scipy', 'matplotlib', 'matplotlib.pyplot', 'scipy.interpolate']
...
import enmapbox
version = u'{}'.format(enmapbox.__version__)
# The full version, including alpha/beta/rc tags.
release = u'{}'.format(enmapbox.__version__)
