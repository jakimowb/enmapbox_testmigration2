...
class IVVRM:
    ...
    def mod_interactive(self):
        ...
        # Outdated: Radio Buttons for Sensor Type
...
class SensorEditor:
    ...
    def open(self):
        self.initial_values()
        self.gui.setWindowTitle("Open Sensor file")
        self.gui.show()
    ...
    def open_file(self):
        ...
        if not file_choice:  # Cancel clicked
            if not self.filenameIn:
                self.houston(message="No File selected")  # no file in memory
            return
