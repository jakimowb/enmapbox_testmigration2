...
class Setup_multiple:
    ...
    def __init__(self, param_input, ns):
        ...
        self.para_dict = {0: 'N', 1: 'cab', 2: 'cw', 3: 'cm', 4: 'LAI', 5: 'typeLIDF', 6: 'LIDF', 7: 'hspot',
                          8: 'psoil', 9: 'cp', 10: 'ccl', 11: 'car', 12: 'anth', 13: 'cbrown', 14: 'tts',
                          15: 'tto', 16: 'psi'}
    ...
    def create_grid(self):
        ...
        for i in range(len(self.whichlogicals)):
        ...
        for i_para in range(self.npara):
...
class Init_Model:
    ...
    def initialize_multiple(self, LUT_dir, LUT_name, ns, tts, tto, psi, N, cab, cw, cm, LAI, LIDF, typeLIDF, hspot,
                            psoil, cp=None, ccl=None, car=None, cbrown=None, anth=None, soil=None, max_per_file=50000,
                            testmode=0, prgbar_widget=None, QGis_app=None):
        ...
        param_input = [N, cab, cw, cm, LAI, typeLIDF, LIDF, hspot, psoil, tts, tto, psi, cp, ccl, car, anth, cbrown]
        self.soil = soil
    ...
    def run_model(self, parameters):
        iModel = Call_model(N=parameters[0],cab=parameters[1],cw=parameters[2],cm=parameters[3],
                            ...
                            car=parameters[14], anth=parameters[15],cbrown=parameters[16],soil=self.soil)
