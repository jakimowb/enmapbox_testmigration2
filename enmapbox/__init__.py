...
URL_TESTDATA = fr'https://bitbucket.org/hu-geomatics/enmap-box-testdata/get/{__version__}.zip'
...
def initAll():
    ...
    from .externals.qps.speclib.core.spectrallibraryio import initSpectralLibraryIOs
