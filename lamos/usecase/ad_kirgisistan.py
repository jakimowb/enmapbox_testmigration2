...
def test(i):
    ...
    filename2 = r'\\141.20.140.91\NAS_Work\EuropeanDataCube\4ad\2007.pkl'
    filename3 = r'\\141.20.140.91\NAS_Work\EuropeanDataCube\4ad\2007.json'
...
#    applier.controls.setNumThreads(16*16)
    ...
    for year in range(start.year, end.year+1):
        ...
        predictor = ClassifierPredictApplier(featureFolder=folder7, featureProduct='stack', featureImage=str(year)+'_stack', featureExtension='.vrt',
                                             labelFolder=folder8, labelProduct='rfc', labelImage=str(year)+'_rfc', labelExtension='.img',
