...
if __name__ == '__main__':
    ...
    tilesfolder = r'\\141.20.140.91\NAS_Work\EuropeanDataCube\testCaseAR_Big\tiles'
    ...
    cubesfolder = r'\\141.20.140.91\NAS_Work\EuropeanDataCube\testCaseAR_Big\cubes'
    dbfile = r'\\141.20.140.91\NAS_Work\EuropeanDataCube\testCaseAR_Big\rasterdb.pickle'
    ...
    def filterFunction(meta):
        year = yaml.load(meta['AcqDate']).year
