...
def run(infolder, outfolder, tmpfolder):
    ...
    # save as ENVI
    MGRSArchive(folder3).saveAsGTiff(folder4, processes=10)

if __name__ == '__main__':

    try:
        infolder, outfolder, tmpfolder = sys.argv
    except:
    ...
    tic()
    run(infolder=infolder, outfolder=outfolder, tmpfolder=tmpfolder)
    toc()
